<?php
        ...
        $sql = "SELECT * FROM orders WHERE order_status = 'completed' OR order_status = 'processing' AND DATE(order_date) >= '$startDate' AND DATE(order_date) <= '$endDate' GROUP BY fbCampaign ORDER BY order_id DESC";
