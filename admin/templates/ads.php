<?php
        ...
        $sql = "SELECT * FROM orders WHERE (order_status = 'completed' AND fbCampaign = '$campaign' AND fbAdset = '$adset') OR (order_status = 'processing' AND fbCampaign = '$campaign' AND fbAdset = '$adset') GROUP BY fbAd ORDER BY order_id DESC";
