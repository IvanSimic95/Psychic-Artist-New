...
if($user_name ) {
    ...
    $finalLink = 'https://www.buygoods.com/secure/upsell?account_id=6490&product_codename='.$countReadings.'xreadings&subid='.$cookie_id.'&subid2='.$lastRowInsert.'&redirect='.$baseRedirect;
